                    ...
                    <div class="bg-secondary rounded p-1 p-sm-5 my-4 mx-">
                        <div class="d-flex align-items-center justify-content-center mb-3">
                          <form action="signin.php" method="post" >
                                <h3 class="text-primary text center"><i></i>iphoneVerse</h3>
                            
                            <h3 class="text-center" >Sign In</h3>
                            
                        </div>
                        <p class="text-white bg-primary p-2 rounded-3"><?php
                        if(isset($_SESSION['msg'])){
                            echo $_SESSION['msg']  ; 
                        }else{
                           echo $_SESSION['msg'] = "Enter your email and password to login";
                        }
                        ?></p>
